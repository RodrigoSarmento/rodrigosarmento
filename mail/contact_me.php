...
if(empty($_POST['name']) ||
 ...
 $to = 'rodrigosarmentoxx@gmail.com'; // Add your email address inbetween the '' replacing yourname@yourdomain.com - This is where the form will send a message to.
 ...
 $headers = "From: noreply@rodrigosarmento.com\n"; // This is the email address the generated message will be from. We recommend using something like noreply@yourdomain.com.
